...
<div class="product_showcase">
    ...
    <div class="product_information">
        ...
        while (have_posts()) : the_post();
            ...
            ?>
            <!--            <small>--><?php //echo $product->get_product_attributes(); ?><!--</small>-->
            ...
            <div class="size_scale">
                <div class="customer_choice_size">
                    <select name="" id="">
                        ...
                        foreach ($attributes as $attribute) {
                            ...
                            ?>
                            <option value="<?php echo $attribute_id; ?>"><?php echo $attribute_name; ?></option>
                            <?php
                        }
                        ?>
                    </select>
                ...
                <div class="size_guide">
                    <svg width="1em" height="1em" fill="#FFFFFF" viewBox="0 0 24 24">
                        <path d="M17.292 1.207L1.206 17.293a1 1 0 000 1.415l4.087 4.086a1 1 0 001.414 0L22.793 6.708a1 1 0 000-1.415l-4.087-4.086a1 1 0 00-1.414 0zM4.015 14.486l2.5 2.5m-.5-4.5L8.03 14.47m.227-4.227l2.5 2.5m-.492-4.507l1.75 1.75M12.5 6L15 8.5M14.5 4l2.015 1.986"
    ...
    <div class="container">
        <div class="product_tab">
            <div class="product_item">
                <div class="product_desciption_item">
