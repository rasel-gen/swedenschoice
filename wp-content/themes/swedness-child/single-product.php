...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="related_products">
            ...
            $related_args = array(
                'orderby' => 'rand', // Order by random to show different related products each time.
                'posts_per_page' => 4, // Number of related products to show.
                'post_type' => 'product', // The post type to query.
                'post_status' => 'publish',
                'tax_query' => array(
                    array(
                        'taxonomy' => 'pa_color', // Replace with your color attribute taxonomy slug.
                        'field' => 'term_id',
                        'terms' => wp_get_post_terms(get_the_ID(), 'pa_color', array('fields' => 'ids')),
                    ),
                    ...
                    <div class="products">
                                ...
                                <div class="swiper">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <?php
                                            echo get_the_post_thumbnail($related_product, 'full');
                                            ?>
                                        </div>
                                        <!-- Slides -->
                                    </div>
                        ...
                        <div class="product_description">
                            <div class="product_title">
                                <h6>
                                    <a href="<?php echo get_permalink($product_id); ?>"><?php echo $related_product_object->get_name(); ?></a>
                                </h6>
                            </div>
                            <div class="product_colors">
                                <?php
                            ...
                            <div class="product_price">
                                <h5>
                                    <?php
                                    echo $related_product_object->get_price_html();
                                    ?>
                                </h5>
                            </div>
